...
export default function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-4 z-50 border border-gray-200 dark:border-gray-700">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
            قم بتثبيت تطبيق Ornina للوصول السريع والاستخدام دون اتصال
          </p>
